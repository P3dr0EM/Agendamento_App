...
void main() {
  ...
  //--- 5. Verifica quando tenta-se logar pelo Admin Local com senha incorreta
  test('Deve rejeitar login admin com senha incorreta', () async {
    controller.emailInput.text = 'admin@admin.com';
    controller.senhaInput.text = 'senhaErrada';

    await controller.logar();

    expect(controller.errorEmail.value, 'E-mail ou senha inválidos!');
    expect(controller.errorPassword.value, 'E-mail ou senha inválidos!');
  });

  //--- 6. Verifica quando o usuário passa credenciais válidas no login
  ...
  //--- 7. Verifica quando o usuário passa credenciais inválidas no login
